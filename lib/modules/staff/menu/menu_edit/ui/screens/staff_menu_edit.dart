...
class StaffMenuEditScreen extends StatefulWidget {
  ...
  const StaffMenuEditScreen({Key key, this.item, this.onSuccess})
      : super(key: key);
                  ...
                  Column(
                    ...
                    children: [
                      Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          SvgPicture.asset(widget.item.isVeg
                ...
                children: [
                  ...
                  DMColorPillButton(
                      ...
                      onPressed: () async {
                        ...
                        if (choice) {
                          isEnabled = !isEnabled;
                          _bloc.add(ChangeEnabledStatus(
                              !isEnabled, widget.item.itemId));
                        }
                      })
                ],
              ),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CheckboxRowWidget(
                    hint: "Dinner",value: time.isDinner,
                      onClick: () {
